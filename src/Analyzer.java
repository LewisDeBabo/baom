...
public class Analyzer {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(analyzer.gibAnzahlDerBlätter(binaryTree));
        System.out.println(analyzer.gibSummeAllerKnoten(binaryTree));
        System.out.println(analyzer.gibMaximumDesBaumes(binaryTree));
